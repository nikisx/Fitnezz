    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TraineesMealPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TraineesMealPlans_MealPlans_MealPlanId",
                        column: x => x.MealPlanId,
                        principalTable: "MealPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TraineesMealPlans_AspNetUsers_TraineeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TraineesWorkouts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TraineesWorkouts_AspNetUsers_TraineeId",
                        column: x => x.TraineeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TraineesWorkouts_Workouts_WorkoutId",
                        column: x => x.WorkoutId,
                        principalTable: "Workouts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TraineesMealPlans_IsDeleted",
                table: "TraineesMealPlans",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_TraineesMealPlans_MealPlanId",
                table: "TraineesMealPlans",
                column: "MealPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_TraineesMealPlans_TraineeId",
                table: "TraineesMealPlans",
                column: "TraineeId");

            migrationBuilder.CreateIndex(
                name: "IX_TraineesWorkouts_IsDeleted",
                table: "TraineesWorkouts",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_TraineesWorkouts_TraineeId",
                table: "TraineesWorkouts",
                column: "TraineeId");

            migrationBuilder.CreateIndex(
                name: "IX_TraineesWorkouts_WorkoutId",
                table: "TraineesWorkouts",
                column: "WorkoutId");
