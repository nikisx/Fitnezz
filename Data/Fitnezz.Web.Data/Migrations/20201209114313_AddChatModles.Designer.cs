...
namespace Fitnezz.Web.Data.Migrations
{
    ...
    [Migration("20201209114313_AddChatModles")]
    partial class AddChatModles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fitnezz.Web.Data.Models.Chat", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Fitnezz.Web.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Fitnezz.Web.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("Fitnezz.Web.Data.Models.Chat", null)
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Fitnezz.Web.Data.Models.Message", b =>
                {
                    b.HasOne("Fitnezz.Web.Data.Models.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId");
                });
